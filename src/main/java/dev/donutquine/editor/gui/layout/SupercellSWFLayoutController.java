...
import dev.donutquine.editor.gui.layout.panels.TexturesPanel;
import dev.donutquine.editor.gui.layout.panels.TimelinePanel;
import dev.donutquine.editor.gui.layout.panels.info.DisplayObjectInfoPanel;
import dev.donutquine.editor.gui.layout.panels.info.MovieClipPropertyPanel;
import dev.donutquine.editor.gui.layout.panels.info.ShapeInfoPanel;
import dev.donutquine.editor.gui.layout.windows.EditorWindow;
import dev.donutquine.editor.gui.layout.windows.UsagesWindow;
import dev.donutquine.editor.gui.navigation.NavigationEvent;
